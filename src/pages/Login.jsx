        ...
        <main className="container--login">
            ...
            <section>
                <form className="form--login" onSubmit={handleLogin}>
                    <h1 className="text-4xl mt-7 mb-3">Pawfect Playdates</h1>
            ...
            <div className="loginLinks">
                <section className="link--register">
                    <Link className="underline text-blue-600 hover:text-blue-800 visited:text-purple-600" to="/register">Not a member yet? Register Here.</Link>
                </section>
            </div>
        </main>
    )
